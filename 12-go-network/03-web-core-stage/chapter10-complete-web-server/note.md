...
**下一阶**：[`chapter11` HTML](../../04-advanced-protocol-stage/chapter11-html-parse/note.md)、[`chapter14` REST](../../04-advanced-protocol-stage/chapter14-rest/note.md) 与 XML/RPC 等；本仓库 [`13-projects-optional`](../../legacy-topic-index/13-projects-optional/) 可作扩展项目池。
